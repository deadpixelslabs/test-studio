  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-['Plus_Jakarta_Sans',sans-serif] selection:bg-emerald-500 selection:text-slate-950 flex flex-col">
      ...
      <footer className="border-t border-slate-900 py-6 text-center text-xs text-slate-500">
        <p>
          GLITCH NFT STUDIO — prompt-driven generative NFT engine with Mistral planning, Mistral Image Generation artwork, composable raster layers, ERC-721 metadata, rarity controls, and ZIP export.
        </p>
      </footer>
    </div>
  );
